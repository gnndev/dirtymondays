...
function custom_event() { 
	...
	register_post_type( 'dm_event', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array('labels' => array(
			'name' => __('Parties', 'dirtymondays'), /* This is the Title of the Group */
			'singular_name' => __('Party', 'dirtymondays'), /* This is the individual type */
			'all_items' => __('All Party', 'dirtymondays'), /* the all items menu item */
	...
	register_post_type( 'concert', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Concerts', 'dirtymondays'), /* This is the Title of the Group */
			'singular_name' => __('Concert', 'dirtymondays'), /* This is the individual type */
			'all_items' => __('All Concerts', 'dirtymondays'), /* the all items menu item */
			'add_new' => __('Add New', 'dirtymondays'), /* The add new menu item */
			'add_new_item' => __('Add New Concert', 'dirtymondays'), /* Add New Display Title */
			'edit' => __( 'Edit', 'dirtymondays' ), /* Edit Dialog */
			'edit_item' => __('Edit Post Types', 'dirtymondays'), /* Edit Display Title */
			'new_item' => __('New Post Type', 'dirtymondays'), /* New Display Title */
			'view_item' => __('View Post Type', 'dirtymondays'), /* View Display Title */
			...
			'menu_position' => 8, /* this is what order you want it to appear in on the left hand side menu */ 
			'menu_icon' => 'dashicons-calendar-alt', /* the icon for the Event type menu. uses built-in dashicons (CSS class name) */
			'rewrite'	=> array( 'slug' => 'presents', 'with_front' => false ), /* you can specify its url slug */

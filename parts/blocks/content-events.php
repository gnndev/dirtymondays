 ...
 <div id="event-block" class="content">
    <h2>UPCOMING SHOWS</h2>
            ...
            if('LosAngeles' == get_field('fuso_orario', get_the_ID())) { 
                ...
                $event_date = new DateTime(get_field('event_date', get_the_ID()), new DateTimeZone('America/Los_Angeles') );
            } else {
            ...
            if( $event_date >= $today ) : ?>
                <div class="cell small-12 medium-2 block-event-field block-event-date"><?php echo $event_date->format('d/m/Y') ?></div>
                ...
                <div class="cell small-12 medium-3 block-event-field block-event-btn">
                    ...
                    <button class="hollow button rsvp-btn load fb-event" data-url="<?php the_field('event_rsvp', get_the_ID()); ?>" >RSVP</a>
                    <?php endif; ?>

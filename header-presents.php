...
<body <?php body_class(); ?>>
    ...
    <div id="header-mobile" class="hide-for-large">
        ...
        <div class="logo-mobile-present">
        <a style="display:block" href="<?php echo home_url(); ?>/presents"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/dm-concerts.jpg" alt="dm concerts"></a>
        </div>
    ...
    <header class="header wrapper show-for-large" role="banner">
        <div class="logo">
           <a style="display:block;padding:10px" href="<?php echo home_url(); ?>/presents"><img style="height:80px;" src="<?php echo get_template_directory_uri(); ?>/assets/images/dmp-logo-red-main.png" alt="Logo"></a>
        </div>
        <a class="bag-icon cart-contents" href="<?php echo wc_get_cart_url(); ?>"
            title="<?php _e('View your shopping cart'); ?>">
            <div class="xoo-wsch-basket" style="position:relative"><?php
